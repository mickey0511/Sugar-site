...
const chartOptions: ApexOptions = {
  ...
  xaxis: {
    categories: [
      ...
      "3/31", "4/2", "4/4", "4/6", "4/8", "4/10", "4/12", "4/14",
      "4/16", "4/18", "4/20", "4/22", "4/24", "4/26", "4/28",
      "4/30", "5/2", "5/4", "5/6", "5/8", "5/10", "5/12", "5/14",
    ],
    labels: {
      style: { colors: "#888" },
    },
    ...
    <section className="py-6 md:py-10 lg:py-12 bg-[#FBFBFB]">
      <div className="max-w-[1440px] px-4 sm:px-6 lg:px-20 mx-auto">
        <div className="w-full flex flex-col items-center justify-center py-12">
          <h1 className="text-3xl md:text-4xl font-semibold text-center text-gray-900 mb-12">
            <span className="text-indigo-600">Historical</span> 60-Days APY
          </h1>

          <div className="w-full bg-white rounded-3xl shadow-[0_6px_16px_rgba(46,35,150,0.06)] p-4">
            <ApexChart
